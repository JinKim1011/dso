...
export default function Home() {
  return (
    <div className="flex flex-col gap-small">
      ...
      <div className="flex gap-mini">
        <Button variant="void" size="large" inline>void-large-inline</Button>
        <Button variant="void" size="regular" inline>void-regular-inline</Button>
        <Button variant="void" size="small" inline>void-small-inline</Button>
        <Button variant="void" size="mini" inline>void-mini-inline</Button>
      </div>
    </div>
  );
}
